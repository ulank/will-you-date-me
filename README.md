# Менімен кездесуге барасың ба? 💛

Қазақ ұлттық нақышындағы (қошқар мүйіз өрнегі, көк/алтын/қызыл палитра) бір беттік
шақыру сайты. Фреймворксіз: таза HTML + CSS + JS.
...
```
index.html   — құрылым + SVG өрнек (қошқар мүйіз)
